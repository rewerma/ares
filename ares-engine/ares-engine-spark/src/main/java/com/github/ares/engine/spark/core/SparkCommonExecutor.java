...
public class SparkCommonExecutor implements Serializable {
    ...
    public Dataset<Row> repartition(
            Dataset<Row> dataset, Integer repartitionNums, List<String> repartitionColumns) {
        logger.info("Repartition by : {}, numbers: {};", repartitionColumns, repartitionNums);
