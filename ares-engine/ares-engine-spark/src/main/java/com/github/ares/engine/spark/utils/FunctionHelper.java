...
public class FunctionHelper {
    ...
    public static Object convert(DynamicFunction dynamicFunction) {
        ...
        if (argCount == 1) {
            UDF1<?, ?> udf1 =
                    (UDF1<Object, Object>)
                            v0 -> dynamicFunction.evaluate(Collections.singletonList(v0));
            return udf1;
        }
        if (argCount == 2) {
            UDF2<?, ?, ?> udf2 =
                    (UDF2<Object, Object, Object>)
                            (v0, v1) -> dynamicFunction.evaluate(Arrays.asList(v0, v1));
            return udf2;
        }
        if (argCount == 3) {
            UDF3<?, ?, ?, ?> udf3 =
                    (UDF3<Object, Object, Object, Object>)
                            (v0, v1, v2) -> dynamicFunction.evaluate(Arrays.asList(v0, v1, v2));
            return udf3;
        }
        if (argCount == 4) {
            UDF4<?, ?, ?, ?, ?> udf4 =
                    (UDF4<Object, Object, Object, Object, Object>)
                            (v0, v1, v2, v3) ->
        ...
        if (argCount == 5) {
            UDF5<?, ?, ?, ?, ?, ?> udf5 =
                    (UDF5<Object, Object, Object, Object, Object, Object>)
                            (v0, v1, v2, v3, v4) ->
        ...
        if (argCount == 6) {
            UDF6<?, ?, ?, ?, ?, ?, ?> udf6 =
                    (UDF6<Object, Object, Object, Object, Object, Object, Object>)
                            (v0, v1, v2, v3, v4, v5) ->
        ...
        if (argCount == 7) {
            UDF7<?, ?, ?, ?, ?, ?, ?, ?> udf7 =
                    (UDF7<Object, Object, Object, Object, Object, Object, Object, Object>)
                            (v0, v1, v2, v3, v4, v5, v6) ->
                                    dynamicFunction.evaluate(
                                            Arrays.asList(v0, v1, v2, v3, v4, v5, v6));
            return udf7;
        }
        if (argCount == 8) {
            UDF8<?, ?, ?, ?, ?, ?, ?, ?, ?> udf8 =
                    (UDF8<Object, Object, Object, Object, Object, Object, Object, Object, Object>)
                            (v0, v1, v2, v3, v4, v5, v6, v7) ->
                                    dynamicFunction.evaluate(
                                            Arrays.asList(v0, v1, v2, v3, v4, v5, v6, v7));
            return udf8;
        }
        if (argCount == 9) {
            UDF9<?, ?, ?, ?, ?, ?, ?, ?, ?, ?> udf9 =
            ...
            UDF10<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?> udf10 =
                    (UDF10<
                            ...
                            (v0, v1, v2, v3, v4, v5, v6, v7, v8, v9) ->
                                    dynamicFunction.evaluate(
                                            Arrays.asList(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9));
            return udf10;
        }
        if (argCount == 11) {
            UDF11<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?> udf11 =
