    ...
    public void execute(
        ...
        if (StringUtils.isNotBlank(mergeIntoSql.getUpdateSourceSql())) {
            ...
            sparkExecutorManager
                    .getUpdateSelectSqlExecutor()
                    .execute(sinkConfig4Update, sinkFactory, updateSelectSQL, plParams);
        }
        ...
        if (StringUtils.isNotBlank(mergeIntoSql.getInsertSourceSql())) {
            ...
            sparkExecutorManager
                    .getInsertSelectSqlExecutor()
                    .execute(sinkConfig4Insert, sinkFactory, insertSelectSQL, plParams);
        }
    }
}
