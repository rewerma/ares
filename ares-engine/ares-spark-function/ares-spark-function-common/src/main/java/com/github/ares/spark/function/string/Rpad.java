...
public class Rpad implements SparkFuncInterface {
    @Override
    ...
    public Object evaluate(List<Object> args) {
        ...
        StringRPad stringRPad = new StringRPad(null, null, null);
        return stringRPad.nullSafeEval(UTF8String.fromString(arg1), arg2.intValue(), UTF8String.fromString(pad));
    }
}
