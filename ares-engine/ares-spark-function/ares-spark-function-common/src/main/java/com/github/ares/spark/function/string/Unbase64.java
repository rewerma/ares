...
public class Unbase64 implements SparkFuncInterface {
    @Override
    ...
    public static byte[] unbase64(String str) {
        org.apache.spark.sql.catalyst.expressions.UnBase64 unBase64 = new org.apache.spark.sql.catalyst.expressions.UnBase64(null);
        return (byte[]) unBase64.nullSafeEval(UTF8String.fromString(str));
    }
}
