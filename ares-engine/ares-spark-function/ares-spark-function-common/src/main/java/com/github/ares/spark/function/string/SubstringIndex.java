...
public class SubstringIndex implements SparkFuncInterface {
    ...
    public Object evaluate(List<Object> args) {
        ...
        org.apache.spark.sql.catalyst.expressions.SubstringIndex substringIndex =
                new org.apache.spark.sql.catalyst.expressions.SubstringIndex(null, null, null);
        return substringIndex.nullSafeEval(
                UTF8String.fromString(str), UTF8String.fromString(arg2), arg3.intValue());
    }
}
