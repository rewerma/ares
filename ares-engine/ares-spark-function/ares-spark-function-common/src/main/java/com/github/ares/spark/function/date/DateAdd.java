...
public class DateAdd implements SparkFuncInterface {
    ...
    public Object evaluate(List<Object> args) {
        ...
        try {
            ...
            org.apache.spark.sql.catalyst.expressions.DateAdd dateAdd = new org.apache.spark.sql.catalyst.expressions.DateAdd(null, null);
            int res = (int) dateAdd.nullSafeEval((int) date.toEpochDay(), days);
