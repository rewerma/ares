...
//            }
//        } else {
//            throw new AresException("Cannot resolve \"to_unix_timestamp(" + arg + ")\" due to data
// type mismatch: " +
//                    "Parameter 1 requires the (\"STRING\" or \"DATE\" or \"TIMESTAMP\") type,
// however \"" + arg + "\" has the type \"" + arg.getClass().getSimpleName() + "\".");
//        }
//
//        ZonedDateTime zonedDateTime =
// dateTime.atZone(ZoneOffset.systemDefault()).withZoneSameInstant(ZoneOffset.UTC);
