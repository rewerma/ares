    ...
    public Object evaluate(List<Object> args) {
        ...
        if (arg1 instanceof LocalDate) {
            ...
            throw new AresException(
                    "Cannot resolve \"next_day("
                            + arg1
                            + ", "
                            + arg2
                            + ")\" due to data type mismatch: "
                            + "Parameter 1 requires the \"DATE\" type, however \""
                            + arg1
                            + "\" has the type \""
        ...
        org.apache.spark.sql.catalyst.expressions.NextDay nextDay =
                new org.apache.spark.sql.catalyst.expressions.NextDay(null, null);
        Object res =
                nextDay.nullSafeEval((int) localDate.toEpochDay(), UTF8String.fromString(arg2));
        if (res != null) {
