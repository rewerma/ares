...
public class Mask implements SparkFuncInterface {
    ...
    public Object evaluate(List<Object> args) {
        ...
        return org.apache.spark.sql.catalyst.expressions.Mask.transformInput(
                        UTF8String.fromString(arg1),
                        maskUpper == null ? null : UTF8String.fromString(maskUpper),
                        maskLower == null ? null : UTF8String.fromString(maskLower),
                        maskDigit == null ? null : UTF8String.fromString(maskDigit),
                        maskOther == null ? null : UTF8String.fromString(maskOther))
                .toString();
    }
}
