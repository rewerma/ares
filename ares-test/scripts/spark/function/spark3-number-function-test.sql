...
assert_equals(acosh(1), 0.0);
assert_equals(asin(1), 1.5707963267948966);
assert_equals(asinh(1), 0.8813735870195429);
assert_equals(atan(1), 0.7853981633974483);
assert_equals(atan2(0, 0), 0.0);
assert_equals(atanh(0), 0.0);

assert_equals(bin(1234), '10011010010');
assert_equals(bit_count(1234), 5);
assert_equals(bit_get(11, 0), 1);
assert_equals(bround(2.5, 0), 2);
assert_equals(cbrt(27.0), 3.0);

assert_equals(ceil(-0.1), 0);
assert_equals(ceil(3.1411, 3), 3.142);
assert_equals(ceil(3.1411, -3), 1000);
assert_equals(ceiling(-0.1), 0);
assert_equals(ceiling(3.1411, 3), 3.142);
assert_equals(ceiling(3.1411, -3), 1000);
...
assert_equals(csc(1), 1.1883951057781212);
...
assert_equals(getbit(11, 0), 1);
assert_equals(getbit(11, 2), 0);
...
assert_equals(pmod(-2, 1.8), 0.2);
assert_equals(pmod(cast(-1.3 as decimal), 2.0), 1.0);
...
assert_equals(to_number('454', '999'), 454);