...
public class SparkTaskExecuteCommand implements Command<SparkCommandArgs> {
    ...
    public SparkTaskExecuteCommand(
            SparkCommandArgs sparkCommandArgs, EngineTypeVersion engineTypeVersion) {
    ...
    public void execute() {
        ...
        try {
            SparkExecution aresTaskExecution =
                    new SparkExecution(engineTypeVersion, sqlFile, jobConfig);
