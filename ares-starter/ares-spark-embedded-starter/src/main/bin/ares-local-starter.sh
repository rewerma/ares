...
CLASS_PATH="${APP_DIR}/starter/logging/*:${APP_DIR}/lib/*:${APP_DIR}/connectors/*:${APP_DIR}/thirdparty/hadoop/*:${APP_DIR}/starter/ares-spark3-starter.jar:${APP_DIR}/starter/ares-spark-embedded-starter.jar"
