...
import com.github.ares.core.starter.command.CommandArgs;
import com.github.ares.core.starter.command.UsageFormatter;
...
public class CommandLineUtils {
    ...
    public static <T extends CommandArgs> T parse(
        ...
        try {
            ...
            // The args is not belongs to Ares, add into engine original parameters
