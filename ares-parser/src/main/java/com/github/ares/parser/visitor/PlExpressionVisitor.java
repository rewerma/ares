...
public class PlExpressionVisitor {
    ...
    public LogicalExpression visitExpressionContext(
            PlSqlParser.ExpressionContext expressionContext,
            Map<String, PlType> params,
            List<String> structs) {
        String expressionStr =
                PLParserUtil.getFullExprWithParams(expressionContext, params, structs);
        return generateExpression(expressionStr);
    }

    public LogicalExpression visitExpressionContext(
            PlSqlParser.ExpressionContext expressionContext, Map<String, PlType> params) {
    ...
    public LogicalExpression visitExpressionContext(
            ...
            List<String> struct) {
        String expressionStr =
                PLParserUtil.getFullExprWithParams(concatenationContext, params, struct);
        return generateExpression(expressionStr);
    }
