...
public interface SqlBaseParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SqlBaseParser#intoClause}.
	 * @param ctx the parse tree
	 */
	void enterIntoClause(SqlBaseParser.IntoClauseContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlBaseParser#intoClause}.
	 * @param ctx the parse tree
	 */
	void exitIntoClause(SqlBaseParser.IntoClauseContext ctx);
	/**
