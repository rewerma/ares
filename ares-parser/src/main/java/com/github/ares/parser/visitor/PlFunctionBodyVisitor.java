    ...
    public List<LogicalOperation> visitBodyStatements(
        ...
        for (PlSqlParser.StatementContext statementContext : statementContextList) {
            ...
            throw new UnsupportedOperationException(
                    String.format(
                            "Unsupported syntax: '%s' in function body",
    ...
    private boolean visitLogicalControlContext(
        ...
        if (statementContext.exit_statement() != null) {
            ...
            LogicalOperation operation =
                    visitorManager
                            .getReturnStatementVisitor()
                            .visitReturnStatement(
                                    statementContext.return_statement(), inParams, declaredParams);
            if (operation != null) {
            ...
            result.add(
                    PlBodyVisitor.toTransactionOperation(statementContext.transaction_statement()));
            resultFlag = true;
        }
