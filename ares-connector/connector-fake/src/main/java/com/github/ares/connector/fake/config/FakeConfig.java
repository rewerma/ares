...
import static com.github.ares.connector.fake.config.FakeOption.BIGINT_MIN;
...
import static com.github.ares.connector.fake.config.FakeOption.DOUBLE_MAX;
import static com.github.ares.connector.fake.config.FakeOption.DOUBLE_MIN;
...
import static com.github.ares.connector.fake.config.FakeOption.FLOAT_MAX;
import static com.github.ares.connector.fake.config.FakeOption.FLOAT_MIN;
...
import static com.github.ares.connector.fake.config.FakeOption.INT_MAX;
import static com.github.ares.connector.fake.config.FakeOption.INT_MIN;
...
import static com.github.ares.connector.fake.config.FakeOption.SMALLINT_MAX;
import static com.github.ares.connector.fake.config.FakeOption.SMALLINT_MIN;
...
import static com.github.ares.connector.fake.config.FakeOption.STRING_LENGTH;
...
import static com.github.ares.connector.fake.config.FakeOption.TINYINT_MAX;
    ...
    public static FakeConfig buildWithConfig(ReadonlyConfig readonlyConfig) {
        ...
        if (readonlyConfig.getOptional(ROWS).isPresent()) {
            ...
            for (Map<String, Object> configItem : configs) {
                ...
                String kind = "INSERT";
                if (configItem.containsKey(RowData.KEY_KIND)) {
                    kind = configItem.get(RowData.KEY_KIND).toString();
                }
                RowData rowData = new RowData(kind, fieldsJson);
                rows.add(rowData);
            }
        ...
        builder.catalogTable(CatalogTableUtil.buildWithConfig("fake", readonlyConfig));
