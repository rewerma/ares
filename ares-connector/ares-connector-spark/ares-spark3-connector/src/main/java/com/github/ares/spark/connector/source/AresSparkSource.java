...
public class AresSparkSource implements DataSourceRegister, TableProvider {
    private static final String SOURCE_NAME = "AresSource";
    ...
    /**
     * Ares spark source <b>not support</b> infer schema information
     *
    ...
    /**
     * The basic unit {@link AresSourceTable} of Ares spark source read
     *
    ...
    public Table getTable(
        ...
        return new AresSourceTable(properties);
    }

    /**
     * Ares DataSource whether support external metadata
     *
