...
import com.github.ares.connctor.jdbc.internal.split.JdbcNumericBetweenParametersProvider;
...
public class FixedChunkSplitter extends ChunkSplitter {
    ...
    private Collection<JdbcSourceSplit> createStringColumnSplits(
            JdbcSourceTable table, String splitKeyName, AresDataType splitKeyType) {
