package com.github.ares.connector.jdbc.internal.xa;

import com.github.ares.common.exceptions.AresException;
import com.github.ares.connector.jdbc.config.JdbcConnectionConfig;
import com.github.ares.connector.jdbc.internal.connection.DataSourceUtils;
import com.github.ares.connector.jdbc.utils.ThrowingRunnable;
    ...
    private static RuntimeException wrapException(String action, Optional<Xid> xid, Exception ex) {
        if (ex instanceof XAException) {
            ...
            if (TRANSIENT_ERR_CODES.contains(xa.errorCode)) {
                throw new AresException(new TransientXaException(xa));
            } else {
                throw new AresException(
